...
public class Borsa {
public final static Integer DEFAULT_PESO_MAX_BORSA = 10;
	...
	public String toString() {
	  ...
	  SortedSet<Attrezzo> getSortedSetOrdinatoPerPeso(){
	   ...
	   List<Attrezzo> getContenutoOrdinatoPerPeso(){
		List<Attrezzo> lp= new ArrayList<>();
		lp.addAll(this.attrezzi.values());
		
		Collections.sort(lp,new ComparatoreAttrezziPerPeso());
		return lp;
	}
